...
type MockChainClient struct {
	getBlockResponse     map[chainhash.Hash]*acmutil.Block
...
func TestUtxoScannerScanBasic(t *testing.T) {
	...
	mockChainClient.SetBlock(&block100000Hash, acmutil.NewBlock(&Block100000))
...
// TestUtxoScannerScanAddBlocks tests that adding new blocks to actrino's view
...
func TestUtxoScannerScanAddBlocks(t *testing.T) {
	...
	mockChainClient.SetBlock(&block99999Hash, acmutil.NewBlock(&Block99999))
...
// The following is taken from the Actinium-project/acmutil project.

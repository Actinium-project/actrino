...
import (
	...
	"github.com/Actinium-project/actrino/chainsync"
	"github.com/Actinium-project/actrino/headerfs"
	"github.com/Actinium-project/actrino/headerlist"
...
type blockManagerCfg struct {
	...
	GetBlock func(chainhash.Hash, ...QueryOption) (*acmutil.Block, error)
...
func (b *blockManager) checkHeaderSanity(blockHeader *wire.BlockHeader,
	...
	stubBlock := acmutil.NewBlock(&wire.MsgBlock{
		Header: *blockHeader,
	})
